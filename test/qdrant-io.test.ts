...
describe('QdrantClient', () => {
    ...
    //     const client = new QdrantClient({ url: 'http://Qdrant-devam-deUEZHm3ij1z-1592083967.ap-northeast-2.elb.amazonaws.com:6333' });
    ...
    //     expect(collectionInfo.name).toBe(collectionName);
    //     expect(collectionInfo.vectors_config.distance).toBe('Cosine');
    // });

    // test('should create payload indexes', async () => {
    //     const collectionName = 'test_collection';
    //     const client = new QdrantClient({ url: 'http://Qdrant-devam-deUEZHm3ij1z-1592083967.ap-northeast-2.elb.amazonaws.com:6333' });
    ...
    //     });
    //     const collectionInfo = await client.getCollection(collectionName);
    //     expect(collectionInfo.payload_index_config.fields.length).toBe(3);
    // });

    test('test main function', async () => {
        await main();
    }, 5 * 60 * 1000); // 3 minutes timeout
});
...
async function main() {
    ...
    const client = new QdrantClient({
        url: 'http://qdrant-devam-tuo4zkktnhry-1377930710.ap-northeast-2.elb.amazonaws.com:6333',
        https: false,
    });
